...
def parse_config():
    ...
    parser.add_argument('--points_path',  type=str, default='D:/Ian/UNI/5_Master_CV/M9_TFM/media/kitti/training/velodyne/')#D:/Ian/UNI/5_Master_CV/M9_TFM/media/openpcdet/training/velodyne/')
    parser.add_argument('--detection_path', type=str, default='D:/Ian/UNI/5_Master_CV/M9_TFM/6_results/kitti/pretrained/pickles/')#D:/Ian/UNI/5_Master_CV/M9_TFM/6_results/20210721_182632/pickles_1/')
    parser.add_argument('--gt_path', type=str, default='D:/Ian/UNI/5_Master_CV/M9_TFM/media/kitti/training/pickles/')#'D:/Ian/UNI/5_Master_CV/M9_TFM/media/beamagine/dataset/pickles/')
    parser.add_argument('--results',type=float,default=True,help='show bboxes')
    parser.add_argument('--sample',type=str,default='000156',help='sample name')#20200219_184540_543
