...
if __name__ == '__main__':
    ...
    #if args.all:
    input_path = 'D:/Ian/UNI/5_Master_CV/M9_TFM/media/pointcloud/ply'
    output_path = 'D:/Ian/UNI/5_Master_CV/M9_TFM/media/pointcloud/prepared_ply'
    #output_path = '/mnt/gpid08/users/ian.riera/media/openpcdet/training/velodyne'
    image_sets_path = 'D:/Ian/UNI/5_Master_CV/M9_TFM/media/dum.txt'#train.txt
    ...
    for subdir, dirs, files in os.walk(input_path):
        for file in files:
            ...
            points.astype(np.float32).tofile(os.path.join(output_path, filename+'.ply'))
    print("a")